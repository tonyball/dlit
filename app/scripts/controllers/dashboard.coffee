...
angular.module('dlitApp')
  .controller 'DashboardCtrl', ($scope, Page, $http,$rootScope, $location) ->
    ...
    $scope.isStudent = $rootScope.isStudent

    if $rootScope.user_id == undefined or $rootScope.user_id == ''
      $location.path("/login")
    else
